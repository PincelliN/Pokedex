  ...
  methods: {
    ...
    ChoosePokemon(id) {
      ...
      if (this.PokemonSelect != null) {
        console.log(this.PokemonSelect.species.url);
          ...
          if (this.PokemonSpecisUrl != null) {
            axios.get(this.PokemonSpecisUrl).then((resptoevol) => {
              ...
              if (resptoevol.data.chain.is_baby != true) {
                this.PrimaForma = resptoevol.data.chain.species.name;
              ...
              console.log(this.PrimaForma, this.Secondaforma, this.TerzaForma);
            });
          }
        });
      }
